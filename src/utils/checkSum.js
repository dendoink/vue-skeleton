...
const stringBuilder = `${appSecret}${Nonce}${CurTime}`;

export const CheckSum = SHA1(stringBuilder)
export const Nonce = GetRandomNum(1, 10000).toString();
export const CurTime = (new Date())
    .getTime()
    .toString();
